  ...
  return (
    <div className="sm:flex gap-32 my-16 ">
      ...
      <Link className='w-1/3' to={`/post/${post._id}`}>
        <img className=" h-full  shadow-lg shadow-cyan-500/50 rounded-lg hover:transform hover:scale-105 hover:shadow-lg hover:cursor-pointer" src={post.imageUrl} alt="post image" />
      </Link>
